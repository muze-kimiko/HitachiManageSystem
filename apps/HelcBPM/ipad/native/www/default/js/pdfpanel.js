...
/* JavaScript content from js/pdfpanel.js in folder common */
Ext.define('Ext.ux.panel.PDF', {
    ...
    config: {
        ...
        loadingMessage: '正在载入, 请稍候...',

        pageText: '{0} / {1} 页',

        hidePagingtoolbar: false,
        
        hideTitletoolbar: false,
        
        toolbarTitle: '查看',
        
        toolbarButtonText: '返回',
        ...
        if (!config.hidePagingtoolbar) {
            ...
            if (!config.hideTitletoolbar) {
            	userItems.push({
	            	...
	            	items: {
                        xtype: 'button',
                        id: config.toolbarButtonItemId,
                        ui: 'back',
                        text: config.toolbarButtonText,
                    }
	            });
            }
    ...
    showLoader: function () {
        ...
        me.setMasked({
            xtype: 'loadmask',
            message: '<font style="color:#aaa">' + me.getLoadingMessage() + '</font>'
        });
        return me;
    },
    ...
    onPdfLoad: function () {
        ...
        if (me.getResizeOnLoad()) {
            me.scale = me.baseScale = Math.min(me.viewportWidth / me.canvasWidth, me.viewportHeight / me.canvasHeight) * 0.98;
        } else {
    ...
    onDoubleTap: function (ev, t) {
        ...
        if (me.scale > me.baseScale) {
            ...
            // zoom in toward tap position
            var oldScale = me.scale,
                newScale = me.baseScale * 2,

                originViewportX = ev ? (ev.pageX - element.getX()) : me.viewportWidth / 2, //0,
                originViewportY = ev ? (ev.pageY - element.getY()) : 0,
