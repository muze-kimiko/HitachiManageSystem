...
/* JavaScript content from resources/js/SliderFieldExtended.js in folder common */
...
//     var value = value;
  ...
  applyComponent: function(config) {
    ...
    var changeValue = function(e) {
      ...
      if(self.config.onChange&&typeof(self.config.onChange)==='function') {
        self.config.onChange(self, helperInputValue);
      }
    };
  ...
  onSliderChange: function(me, thumb, newValue, oldValue) {
    ...
    if(this.config.onChange&&typeof(this.config.onChange)==='function') {
      this.config.onChange(this, newValue);
    }
  },
