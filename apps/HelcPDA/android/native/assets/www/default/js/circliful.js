...
/* JavaScript content from js/circliful.js in folder common */
"use strict";
        ...
        return this.each(function () {
            ...
            circleContainer
                ...
                .append(
                    $('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                        ...
                        '<text class="timer" text-anchor="middle" x="100" y="110" style="font-size: 35px;" >0%</text>')
                );
            ...
            if(settings.animation == 1) {
                var timer = window.setInterval(function () {console.log(count++)
                    ...
                    circle
                        .attr("stroke-dasharray", angle * 57 / 57 + ", 10000");
                ...
                circle
                    .attr("stroke-dasharray", ((360 / 100 * percent)*57/57) + ", 10000");
