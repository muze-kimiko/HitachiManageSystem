...
/* JavaScript content from js/signaturefield.js in folder common */
...
//
       this.width = this.getSigWidth();
        ...
        console.log( this.getSigWidth()+"*"+this.getSigHeight());
//        this.width = 1000;
//        this.height = 1000;
        ...
        this.actionOverlayCanvas.setStyle('border:none;height:628px;width:280px;margin-right:auto;margin-left:auto;margin-top:auto;margin-bottom:auto;');
