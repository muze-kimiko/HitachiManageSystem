...
/* JavaScript content from app/controller/transport/TransportCtrl.js in folder common */
Ext.define('HelcPDA.controller.transport.TransportCtrl',{
...
//		this.showBackView('com_part_Project_id','HelcPDA.view.fitting.com_part_Project');
	...
	btn_Back_TR:function(){
		//跳转页面
		this.BackView();
//		this.showBackView("TransportSearch","HelcPDA.view.transport.TransportSearch");
	},
	/*
	btn_Back_P:function(){
		//跳转页面     
	...
	*/
	//进入历史故障查询页面
	in_transport:function(obk, index, target, record, e, eOpts ){
	...
	btn_Search_TS:function(){
		...
		//跳转页面     
		this.NextView('TransportResult','HelcPDA.view.transport.TransportResult');
