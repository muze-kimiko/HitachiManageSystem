...
/* JavaScript content from app/view/oa/startTheProcess/QualityControl/ThreeGuarantees.js in folder common */
Ext.define('HelcPDA.view.oa.startTheProcess.QualityControl.ThreeGuarantees', {
    extend: 'Ext.Panel',
    id: 'qc_ThreeGuarantees_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
                        ...
                        items: [
                            {
                                ...
                                listeners:{
                                	change:function(){
                                		objj.getApplication().getController('oa.startTheProcess.QualityControl.ThreeGuaranteesCtrl').GetElevator_no_Info2();
                                	}
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                listeners:{
                                	change:function(){
                                		objj.getApplication().getController('oa.startTheProcess.QualityControl.ThreeGuaranteesCtrl').GetImportant();
                                	}
                                }
                            },
                            {
                        ...
                        items: [
                            {
                                ...
                                listeners:{
                                	change:function(){
                                		objj.getApplication().getController('oa.startTheProcess.QualityControl.ThreeGuaranteesCtrl').GetPartsInfo();
                                	}
                                }
                            },
                            {
...
//                    {
//                        xtype: 'fieldset',
//                        title: '以上由各工厂/日滨/电机品证部处理人填写',
//                        items: [
//                            {
//                                xtype: 'selectfield',
//                                label: '是否需要下计划（由物流管理科计划员选择）',
//                                labelWidth: '40%',
//                                id: 'isneedtocreate',
//                                options: [
//                                          {
