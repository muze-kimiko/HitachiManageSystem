...
/* JavaScript content from app/controller/oa/startTheProcess/DailyOffice/travelRequestCtrl.js in folder common */
Ext.define('HelcPDA.controller.oa.startTheProcess.DailyOffice.travelRequestCtrl',{
	...
	FreeControl : function(){
	    ...
	    var getResult=function(res){
			...
			if(data[0].State=='3'){
				...
				obj.getApplication().getController('oa.startTheProcess.startTheProcessNameCtrl').public_ToSelectNode();
			};
		};
