...
/* JavaScript content from app/view/oa/MyProcess/ProposalManage/PM_TAGLLC_NG.js in folder common */
Ext.define('HelcPDA.view.oa.MyProcess.ProposalManage.PM_TAGLLC_NG', {
    extend: 'Ext.Panel',
    id:'wdlc_PM_TAGLLC_NG_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
