...
/* JavaScript content from app/view/oa/startTheProcess/BusinessService/MaintainTransformView.js in folder common */
Ext.define('HelcPDA.view.oa.startTheProcess.BusinessService.MaintainTransformView', {
    extend: 'Ext.Panel',
    id: 'qc_MaintainTransformView_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
