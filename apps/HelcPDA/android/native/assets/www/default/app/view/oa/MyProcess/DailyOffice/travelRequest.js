...
/* JavaScript content from app/view/oa/MyProcess/DailyOffice/travelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcPDA.view.oa.MyProcess.DailyOffice.travelRequest', {
    extend: 'Ext.Panel',
    id: 'wdlc_travelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
