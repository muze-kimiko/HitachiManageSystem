...
/* JavaScript content from app/view/oa/startTheProcess/BusinessService/litigationApprove.js in folder common */
Ext.define('HelcPDA.view.oa.startTheProcess.BusinessService.litigationApprove', {
	extend : 'Ext.Panel',
	id : 'qc_litigationApprove_id',
...
//					，以便律师函准确送达
					items : [{
						...
						listeners:{
							blur:function(){
								Ext.getCmp('subject').setValue(Ext.getCmp('hth').getValue()+Ext.getCmp('dwmc1').getValue()+"诉讼审批流程");
							}
						}
					},{
						xtype : 'textfield',
