...
/* JavaScript content from app/view/oa/MyProcess/QualityControl/ThreeGuarantees.js in folder common */
Ext.define('HelcPDA.view.oa.MyProcess.QualityControl.ThreeGuarantees', {
    extend: 'Ext.Panel',
    id: 'wdlc_ThreeGuarantees_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
