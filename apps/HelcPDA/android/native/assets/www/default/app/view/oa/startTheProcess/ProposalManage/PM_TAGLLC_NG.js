...
/* JavaScript content from app/view/oa/startTheProcess/ProposalManage/PM_TAGLLC_NG.js in folder common */
Ext.define('HelcPDA.view.oa.startTheProcess.ProposalManage.PM_TAGLLC_NG', {
    extend: 'Ext.Panel',
    id:'qc_PM_TAGLLC_NG_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
