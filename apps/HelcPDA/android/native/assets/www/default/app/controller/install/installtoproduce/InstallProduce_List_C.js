...
/* JavaScript content from app/controller/install/installtoproduce/InstallProduce_List_C.js in folder common */
Ext.define('HelcPDA.controller.install.installtoproduce.InstallProduce_List_C',{
...
config:{
		...
		init3:function(obj, index, target, record, e, eOpts){
			//进入排产列表
			this.NextView('InstallProduce_EnoList_VID','HelcPDA.view.install.installtoproduce.InstallProduce_EnoList_V');
		...
		searchId_old:function(){
			this.NextView('InstallProduce_Query_id','HelcPDA.view.install.installtoproduce.InstallProduce_Query_V');
		},
