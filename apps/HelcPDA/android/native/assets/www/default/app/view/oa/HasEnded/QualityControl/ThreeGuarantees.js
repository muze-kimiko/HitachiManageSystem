...
/* JavaScript content from app/view/oa/HasEnded/QualityControl/ThreeGuarantees.js in folder common */
Ext.define('HelcPDA.view.oa.HasEnded.QualityControl.ThreeGuarantees', {
    extend: 'Ext.Panel',
    id: 'yjs_ThreeGuarantees_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
