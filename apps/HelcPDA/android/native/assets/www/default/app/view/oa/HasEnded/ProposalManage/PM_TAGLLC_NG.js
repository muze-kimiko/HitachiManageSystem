...
/* JavaScript content from app/view/oa/HasEnded/ProposalManage/PM_TAGLLC_NG.js in folder common */
Ext.define('HelcPDA.view.oa.HasEnded.ProposalManage.PM_TAGLLC_NG', {
    extend: 'Ext.Panel',
    id:'yjs_PM_TAGLLC_NG_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
