...
/* JavaScript content from app/view/oa/HasEnded/BusinessService/MaintainTransformView.js in folder common */
Ext.define('HelcPDA.view.oa.HasEnded.BusinessService.MaintainTransformView', {
    extend: 'Ext.Panel',
    id: 'yjs_MaintainTransformView_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
