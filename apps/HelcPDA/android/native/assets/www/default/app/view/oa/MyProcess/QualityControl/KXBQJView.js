...
/* JavaScript content from app/view/oa/MyProcess/QualityControl/KXBQJView.js in folder common */
Ext.define('HelcPDA.view.oa.MyProcess.QualityControl.KXBQJView', {
    extend: 'Ext.Panel',
    id: 'wdlc_KXBQJView_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
