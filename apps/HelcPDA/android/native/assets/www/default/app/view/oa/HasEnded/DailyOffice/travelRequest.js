...
/* JavaScript content from app/view/oa/HasEnded/DailyOffice/travelRequest.js in folder common */
Ext.define('HelcPDA.view.oa.HasEnded.DailyOffice.travelRequest', {
    extend: 'Ext.Panel',
    id: 'yjs_travelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
