...
/* JavaScript content from app/controller/oa/startTheProcess/DailyOffice/Idea/personnelSelectionCtrl.js in folder common */
/**
 * 起草流程-人员选择
 */
Ext.define('HelcPDA.controller.oa.startTheProcess.DailyOffice.Idea.personnelSelectionCtrl',{
...
//			var store = this.getStore('personnelSelectionS','HelcOA.store.startTheProcess.DailyOffice.Idea.personnelSelectionS');
			...
			this.showBackView('qc_approvalOpinion_ID','HelcPDA.view.oa.startTheProcess.DailyOffice.Idea.approvalOpinion');
	...
	qc_staffQuery : function(obj, e, eOpts){
		...
		if(!store){
			store=Ext.create("HelcPDA.store.oa.startTheProcess.DailyOffice.Idea.qyeryListStore");
		}
		store.setData([]);
		...
		this.NextView('qc_qyeryList_id','HelcPDA.view.oa.startTheProcess.DailyOffice.Idea.qyeryList');
	},
