...
/* JavaScript content from app/view/oa/startTheProcess/DailyOffice/Idea/qyeryList.js in folder common */
/**
 * 起草-人员查询列表
 */
Ext.define('HelcPDA.view.oa.startTheProcess.DailyOffice.Idea.qyeryList', {
	    extend: 'Ext.Panel',
	    id: 'qc_qyeryList_id',
	    requires: [
	        'Ext.Toolbar',
