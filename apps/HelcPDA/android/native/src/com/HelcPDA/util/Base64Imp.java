package com.HelcPDA.util;

import java.io.File;
import java.io.FileInputStream;
import java.io.FileOutputStream;

import com.HelcPDA.util.encoder.BASE64Decoder;
import com.HelcPDA.util.encoder.BASE64Encoder;


public class Base64Imp {
	
	/*public static void main(String[] args) {
		String result = encodeBase64File("D:/HitachiMiss_Database/xml/1-7LXO_底坑.xml");
