...
import com.HelcPDA.CommonPlugin.MaaS360Detect;
...
public class SDKListener implements IMaaS360SDKListener
{
    ...
    MaaS360DeviceIdentityAttributes mdia = null;
    MaaS360Context cdia = null;
...
//        }
        ...
        MaaS360SDKContextWrapper wrapper = null;
		try {
			wrapper = MaaS360SDKContextWrapper.getSharedInstance(true);
		} catch (MaaS360SDKNotActivatedException e) {
			e.printStackTrace();
		}
        mdia = wrapper.getDeviceIdentityAttributes();
        cdia = wrapper.getContext();
        MaaS360Detect.IsMaaS360Activated="SDKisSuccess";
    	String text = new Gson().toJson(mdia);
    	if(text.equals("{\"mKeyValuePairs\":{}}")){
    		text = new Gson().toJson(cdia);
    	}
    	MaaS360Detect.MaaS360Info=text;
    	return;
    }
...
//            try {
//                if (MaaS360AppUtils.isAppInForeground(MainApplication.getApplication())
//                        && MaaS360SDKContextWrapper.getSharedInstance(true).getAutoEnforceInfo().shouldAutoEnforceSSO()) {
//                    MaaS360SDK.checkForSSO();
//                }
//            }
//            catch (MaaS360SDKNotActivatedException e) {
