...
Ext.define('HelcAgent.view.OpportunityManagement.Project_New.InstallSiteCompanyView',{
					    ...
					    items: [
						        {
						            ...
						            handler:function(){
						            	...
						            	if(!store)
						            		store = Ext.create('HelcAgent.store.OpportunityManagement.Project_New.InstallSiteCompanyStore');
						            	console.log(records);
