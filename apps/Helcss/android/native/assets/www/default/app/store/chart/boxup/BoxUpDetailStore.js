...
/* JavaScript content from app/store/chart/boxup/BoxUpDetailStore.js in folder common */
Ext.define("Helcss.store.chart.boxup.BoxUpDetailStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.boxup.BoxUpDetailModel"],
    config : {
    	model : 'Helcss.model.chart.boxup.BoxUpDetailModel'
    	/*
