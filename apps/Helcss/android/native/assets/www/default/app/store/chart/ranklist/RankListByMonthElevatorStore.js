...
/* JavaScript content from app/store/chart/ranklist/RankListByMonthElevatorStore.js in folder common */
Ext.define("Helcss.store.chart.ranklist.RankListByMonthElevatorStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.ranklist.RankListByMonthElevatorModel"],
    config : {
    	model : 'Helcss.model.chart.ranklist.RankListByMonthElevatorModel'
    		/*
		data: [
