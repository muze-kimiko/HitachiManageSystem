...
/* JavaScript content from app/store/chart/boxup/BoxUpByMonthDetailStore.js in folder common */
Ext.define("Helcss.store.chart.boxup.BoxUpByMonthDetailStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.boxup.BoxUpByMonthDetailModel"],
    config : {
    	model : 'Helcss.model.chart.boxup.BoxUpByMonthDetailModel'
    	/*
