...
/* JavaScript content from app/store/chart/boxup/BoxUpChartStore.js in folder common */
Ext.define("Helcss.store.chart.boxup.BoxUpChartStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.boxup.BoxUpChartModel"],
    config : {
    	model : 'Helcss.model.chart.boxup.BoxUpChartModel'
    		/*
		data: [
