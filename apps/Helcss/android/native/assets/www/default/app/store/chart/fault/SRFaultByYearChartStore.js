...
/* JavaScript content from app/store/chart/fault/SRFaultByYearChartStore.js in folder common */
Ext.define("Helcss.store.chart.fault.SRFaultByYearChartStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.fault.SRFaultByYearChartModel"],
    config : {
    	model : 'Helcss.model.chart.fault.SRFaultByYearChartModel'
    		/*
		data: [
