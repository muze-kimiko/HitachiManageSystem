...
/* JavaScript content from app/view/install/InstInfoDetailView.js in folder common */
Ext.define('Helcss.view.install.InstInfoDetailView', {
    extend: 'Ext.Panel',
    id:'inst_info_detailview',
    config: {
    	fullscreen: true,
    	layout: 'vbox',
        items: [
