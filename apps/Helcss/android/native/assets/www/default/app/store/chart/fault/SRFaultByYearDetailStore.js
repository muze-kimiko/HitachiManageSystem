...
/* JavaScript content from app/store/chart/fault/SRFaultByYearDetailStore.js in folder common */
Ext.define("Helcss.store.chart.fault.SRFaultByYearDetailStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.fault.SRFaultByYearDetailModel"],
    config : {
    	model : 'Helcss.model.chart.fault.SRFaultByYearDetailModel'
    	/*
