...
/* JavaScript content from app/store/chart/fault/FaultDetailStore.js in folder common */
Ext.define("Helcss.store.chart.fault.FaultDetailStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.fault.FaultDetailModel"],
    config : {
    	model : 'Helcss.model.chart.fault.FaultDetailModel'
    	/*
