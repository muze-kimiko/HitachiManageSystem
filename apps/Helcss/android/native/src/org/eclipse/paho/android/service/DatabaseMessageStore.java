...
//		DatabaseMessageStore.AppType apptype = DatabaseMessageStore.AppType.valueOf(topic.
//				substring( topic.lastIndexOf("/")+1, topic.length()));
//		switch (apptype) {
//		case G001:
//			service.showNotification("收到新的待处理故障信息");
//			break;
//		case AZ01:
//			service.showNotification("收到新的安装任务信息");
//			break;
//		case AZ02:
//			service.showNotification("收到新的排产任务信息");
//			break;
//		case AZ03:
//			service.showNotification("收到新的发货任务信息");
//			break;
//		case AZ04:
//			service.showNotification("收到新的调试任务信息");
//			break;
//		default:
//			break;
//		}
...
//		service.showNotification(statusText);
		service.showNotificationWithSound(statusText);
	}
