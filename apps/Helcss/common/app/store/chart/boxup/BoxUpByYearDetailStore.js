Ext.define("Helcss.store.chart.boxup.BoxUpByYearDetailStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.boxup.BoxUpByYearDetailModel"],
    config : {
    	model : 'Helcss.model.chart.boxup.BoxUpByYearDetailModel'
    	/*
