Ext.define("Helcss.store.chart.boxup.BoxUpByMonthChartStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.boxup.BoxUpByMonthChartModel"],
    config : {
    	model : 'Helcss.model.chart.boxup.BoxUpByMonthChartModel'
    		/*
		data: [
