...
/* JavaScript content from app/store/chart/ranklist/RankListByMonthDomainStore.js in folder common */
Ext.define("Helcss.store.chart.ranklist.RankListByMonthDomainStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.ranklist.RankListByMonthDomainModel"],
    config : {
    	model : 'Helcss.model.chart.ranklist.RankListByMonthDomainModel'
    		/*
		data: [
