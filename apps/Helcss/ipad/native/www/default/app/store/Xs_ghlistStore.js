...
/* JavaScript content from app/store/Xs_ghlistStore.js in folder common */
/**
 * Xs_ghlistStore
 */
Ext.define("Helcss.store.Xs_ghlistStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.XunshighModel"],
    config : {
    	model : 'Helcss.model.XunshighModel'
