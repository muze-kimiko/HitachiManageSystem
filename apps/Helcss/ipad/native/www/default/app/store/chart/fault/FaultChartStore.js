...
/* JavaScript content from app/store/chart/fault/FaultChartStore.js in folder common */
Ext.define("Helcss.store.chart.fault.FaultChartStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.fault.FaultChartModel"],
    config : {
    	model : 'Helcss.model.chart.fault.FaultChartModel'
    		/*
		data: [
