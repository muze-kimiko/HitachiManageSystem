...
/* JavaScript content from app/store/chart/boxup/BoxUpByYearChartStore.js in folder common */
Ext.define("Helcss.store.chart.boxup.BoxUpByYearChartStore", {
	extend : 'Ext.data.Store',
	requires : ["Helcss.model.chart.boxup.BoxUpByYearChartModel"],
    config : {
    	model : 'Helcss.model.chart.boxup.BoxUpByYearChartModel'
    		/*
		data: [
