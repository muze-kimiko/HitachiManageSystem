...
/* JavaScript content from app/view/startTheProcess/QualityControl/KXBQJView.js in folder common */
Ext.define('HelcOA.view.startTheProcess.QualityControl.KXBQJView', {
    extend: 'Ext.Panel',
    id: 'qc_KXBQJView_id',
    requires: [
        'Ext.Toolbar',
