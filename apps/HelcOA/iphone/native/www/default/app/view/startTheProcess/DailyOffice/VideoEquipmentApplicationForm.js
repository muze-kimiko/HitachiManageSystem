...
/* JavaScript content from app/view/startTheProcess/DailyOffice/VideoEquipmentApplicationForm.js in folder common */
Ext.define('HelcOA.view.startTheProcess.DailyOffice.VideoEquipmentApplicationForm', {
    extend: 'Ext.Panel',
    id:'qc_VideoEquipmentApplicationForm_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
