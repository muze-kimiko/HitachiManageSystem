...
/* JavaScript content from app/view/Approved/DailyOffice/propertyContractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.Approved.DailyOffice.propertyContractExamine', {
    extend: 'Ext.Panel',
    id:'ysp_propertyContractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
