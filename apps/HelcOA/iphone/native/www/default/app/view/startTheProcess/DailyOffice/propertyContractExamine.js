...
/* JavaScript content from app/view/startTheProcess/DailyOffice/propertyContractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.startTheProcess.DailyOffice.propertyContractExamine', {
    extend: 'Ext.Panel',
    id:'qc_propertyContractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
