...
/* JavaScript content from app/view/startTheProcess/BusinessService/Invoice.js in folder common */
Ext.define('HelcOA.view.startTheProcess.BusinessService.Invoice', {
    extend: 'Ext.Panel',
    id: 'qc_Invoice_id',
    requires: [
        'Ext.Toolbar',
