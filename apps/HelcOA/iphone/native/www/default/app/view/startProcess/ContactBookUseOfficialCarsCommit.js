...
/* JavaScript content from app/view/startProcess/ContactBookUseOfficialCarsCommit.js in folder common */
/*
...
Ext.define('HelcOA.view.startProcess.ContactBookUseOfficialCarsCommit', {
    extend: 'Ext.Panel',
                ...
                items: [
                    {
                        ...
                        listeners:{
                        	tap:function(){
                				...
                				if(!obj){
                					obj=Ext.create('HelcOA.view.startProcess.ContactBookUseOfficialCars');
                				}
