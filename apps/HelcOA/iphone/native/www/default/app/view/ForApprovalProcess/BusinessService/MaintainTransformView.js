...
/* JavaScript content from app/view/ForApprovalProcess/BusinessService/MaintainTransformView.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.BusinessService.MaintainTransformView', {
    extend: 'Ext.Panel',
    id: 'sp_MaintainTransformView_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
