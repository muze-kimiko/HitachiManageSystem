...
/* JavaScript content from app/view/startProcess/WorkContactBookCommit.js in folder common */
/*
                ...
                items: [
                    {
                        ...
                        listeners:{
                        	tap:function(){
                				...
                				if(!obj){
                					obj=Ext.create('HelcOA.view.startProcess.WorkContactBook');
                				}
