...
/* JavaScript content from app/view/startTheProcess/QualityControl/QualityComplain.js in folder common */
Ext.define('HelcOA.view.startTheProcess.QualityControl.QualityComplain', {
    extend: 'Ext.Panel',
    id: 'qc_QualityComplain_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
