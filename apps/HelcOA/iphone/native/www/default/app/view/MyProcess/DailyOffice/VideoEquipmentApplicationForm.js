...
/* JavaScript content from app/view/MyProcess/DailyOffice/VideoEquipmentApplicationForm.js in folder common */
Ext.define('HelcOA.view.MyProcess.DailyOffice.VideoEquipmentApplicationForm', {
    extend: 'Ext.Panel',
    id:'wdlc_VideoEquipmentApplicationForm_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
