...
/* JavaScript content from app/view/MyProcess/DailyOffice/contractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.MyProcess.DailyOffice.contractExamine', {
    extend: 'Ext.Panel',
    id:'wdlc_contractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
