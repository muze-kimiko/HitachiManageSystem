...
/* JavaScript content from app/view/startTheProcess/DailyOffice/contractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.startTheProcess.DailyOffice.contractExamine', {
    extend: 'Ext.Panel',
    id:'qc_contractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
