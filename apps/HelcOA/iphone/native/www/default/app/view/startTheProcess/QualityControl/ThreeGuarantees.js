...
/* JavaScript content from app/view/startTheProcess/QualityControl/ThreeGuarantees.js in folder common */
Ext.define('HelcOA.view.startTheProcess.QualityControl.ThreeGuarantees', {
    extend: 'Ext.Panel',
                        ...
                        items: [
                            {
                                ...
                                listeners:{
                                	change:function(){
                                		object.getApplication().getController('startTheProcess.QualityControl.ThreeGuaranteesCtrl').GetElevator_no_Info2();
                                	}
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                listeners:{
                                	change:function(){
                                		object.getApplication().getController('startTheProcess.QualityControl.ThreeGuaranteesCtrl').GetImportant();
                                	}
                                }
                            },
                            {
                        ...
                        items: [
                            {
                                ...
                                listeners:{
                                	change:function(){
                                		object.getApplication().getController('startTheProcess.QualityControl.ThreeGuaranteesCtrl').GetPartsInfo();
                                	}
                                }
                            },
                            {
