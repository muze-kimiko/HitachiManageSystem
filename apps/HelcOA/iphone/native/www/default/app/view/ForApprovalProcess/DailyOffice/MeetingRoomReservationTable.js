...
/* JavaScript content from app/view/ForApprovalProcess/DailyOffice/MeetingRoomReservationTable.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.DailyOffice.MeetingRoomReservationTable', {
    extend: 'Ext.Panel',
    id:'sp_MeetingRoomReservationTable_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        listeners:{
                                        	tap:function(){
                                        		object.getApplication().getController('startTheProcess.DailyOffice.MeetingRoomReservationCtrl').CheckMeetRoom();
                                        	}
                                        }
                                    },
                                    {
