...
/* JavaScript content from app/view/startTheProcess/DailyOffice/MeetingRoomReservationTable.js in folder common */
Ext.define('HelcOA.view.startTheProcess.DailyOffice.MeetingRoomReservationTable', {
    extend: 'Ext.Panel',
    id:'qc_MeetingRoomReservationTable_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
