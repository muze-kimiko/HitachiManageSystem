...
/* JavaScript content from app/view/Approved/DailyOffice/travelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.Approved.DailyOffice.travelRequest', {
    extend: 'Ext.Panel',
    id: 'ysp_travelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
