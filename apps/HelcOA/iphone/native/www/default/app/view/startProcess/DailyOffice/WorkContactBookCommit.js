...
/* JavaScript content from app/view/startProcess/DailyOffice/WorkContactBookCommit.js in folder common */
/*
...
Ext.define('HelcOA.view.startProcess.DailyOffice.WorkContactBookCommit', {
    extend: 'Ext.Panel',
   id:'WorkContactBookCommit_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
