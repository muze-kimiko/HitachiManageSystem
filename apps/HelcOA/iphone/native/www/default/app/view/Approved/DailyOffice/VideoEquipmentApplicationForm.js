...
/* JavaScript content from app/view/Approved/DailyOffice/VideoEquipmentApplicationForm.js in folder common */
Ext.define('HelcOA.view.Approved.DailyOffice.VideoEquipmentApplicationForm', {
    extend: 'Ext.Panel',
    id:'ysp_VideoEquipmentApplicationForm_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
