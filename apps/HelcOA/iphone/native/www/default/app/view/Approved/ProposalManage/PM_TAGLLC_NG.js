...
/* JavaScript content from app/view/Approved/ProposalManage/PM_TAGLLC_NG.js in folder common */
Ext.define('HelcOA.view.Approved.ProposalManage.PM_TAGLLC_NG', {
    extend: 'Ext.Panel',
    id:'ysp_PM_TAGLLC_NG_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
