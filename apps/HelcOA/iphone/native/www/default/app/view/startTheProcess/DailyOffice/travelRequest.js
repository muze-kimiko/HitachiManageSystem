...
/* JavaScript content from app/view/startTheProcess/DailyOffice/travelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.startTheProcess.DailyOffice.travelRequest', {
    extend: 'Ext.Panel',
    id: 'travelRequest_ID',
    requires: [
        'Ext.Toolbar',
