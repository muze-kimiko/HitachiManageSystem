...
/* JavaScript content from app/view/ForApprovalProcess/DailyOffice/VideoEquipmentApplicationForm.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.DailyOffice.VideoEquipmentApplicationForm', {
    extend: 'Ext.Panel',
    id:'sp_VideoEquipmentApplicationForm_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
...
//                                        listeners:{
//                                        	tap:function(){
//                                        		object.NextView('qc_MeetingRooms_id','HelcOA.view.startTheProcess.DailyOffice.MeetingRooms');
//                                        	}
//                                        }
                                    }
                                ]
