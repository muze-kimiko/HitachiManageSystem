...
/* JavaScript content from app/view/startTheProcess/DailyOffice/CustomerReception.js in folder common */
Ext.define('HelcOA.view.startTheProcess.DailyOffice.CustomerReception', {
    extend: 'Ext.Panel',
    id: 'qc_CustomerReception_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
