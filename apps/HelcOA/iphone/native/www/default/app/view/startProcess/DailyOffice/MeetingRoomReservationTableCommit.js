...
/* JavaScript content from app/view/startProcess/DailyOffice/MeetingRoomReservationTableCommit.js in folder common */
/*
...
Ext.define('HelcOA.view.startProcess.DailyOffice.MeetingRoomReservationTableCommit', {
    extend: 'Ext.Panel',
   id:'MeetingRoomReservationTableCommit_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
