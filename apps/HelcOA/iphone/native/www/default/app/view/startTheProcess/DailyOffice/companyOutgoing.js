...
/* JavaScript content from app/view/startTheProcess/DailyOffice/companyOutgoing.js in folder common */
/*
...
Ext.define('HelcOA.view.startTheProcess.DailyOffice.companyOutgoing', {
    extend: 'Ext.Panel',
    id:'qc_companyOutgoing_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
                        ...
                        items: [
                            {
							        ...
							        listeners:{
                                    	tap:function(){
                                    		object.getApplication().getController('PublicPersonnelSelectionC').selectPerson('readpeo');
                                    	}
                                    }
							    },]
							},
