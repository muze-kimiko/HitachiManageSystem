...
/* JavaScript content from app/view/Approved/QualityControl/ThreeGuarantees.js in folder common */
Ext.define('HelcOA.view.Approved.QualityControl.ThreeGuarantees', {
    extend: 'Ext.Panel',
    id: 'ysp_ThreeGuarantees_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
