...
/* JavaScript content from app/controller/startTheProcess/BusinessService/litigationApproveCtrl.js in folder common */
Ext.define('HelcOA.controller.startTheProcess.BusinessService.litigationApproveCtrl',{
	extend:'HelcOA.controller.ApplicationController',
	id:'qc_litigationApproveCtrl_id',
	config:{
		control:{
		}
	},
