...
/* JavaScript content from app/controller/PublicPersonnelSelectionC.js in folder common */
Ext.define('HelcOA.controller.PublicPersonnelSelectionC',{
	...
	selectPerson : function(textId){
		...
		store.setData([]);
		this.NextView('PublicPersonnelSelection_id','HelcOA.view.PublicPersonnelSelection');
...
//				item_.idx=Ext.getCmp('QC_idx').getValue();
	...
	public_sreach_peson : function(obj, e, eOpts){
		...
		var store = this.getStore('PublicQyeryListStore','HelcOA.store.PublicQyeryListStore');
...
//				}
		...
		this.NextView('PublicQyeryList_id','HelcOA.view.PublicQyeryList');
	},
