...
/* JavaScript content from app/view/ForApprovalProcess/QualityControl/ComplatinSheet.js in folder common */
/**
 * 公司级投诉电子流程表
 */
Ext.define('HelcOA.view.ForApprovalProcess.QualityControl.ComplatinSheet', {
    extend: 'Ext.Panel',
    id: 'sp_ComplatinSheet_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
