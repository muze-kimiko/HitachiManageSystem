...
/* JavaScript content from app/view/MyProcess/BusinessService/litigationApplyandRemove.js in folder common */
Ext.define('HelcOA.view.MyProcess.BusinessService.litigationApplyandRemove', {
    extend: 'Ext.Panel',
    id: 'wdlc_litigationApplyandRemove_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
