...
/* JavaScript content from app/view/Approved/Technology/FileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.Approved.Technology.FileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'ysp_FileBorrowingOrCopy_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
