...
/* JavaScript content from app/view/MyProcess/DailyOffice/propertyContractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.MyProcess.DailyOffice.propertyContractExamine', {
    extend: 'Ext.Panel',
    id:'wdlc_propertyContractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
