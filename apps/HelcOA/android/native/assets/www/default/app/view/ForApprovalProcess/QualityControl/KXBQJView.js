...
/* JavaScript content from app/view/ForApprovalProcess/QualityControl/KXBQJView.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.QualityControl.KXBQJView', {
    extend: 'Ext.Panel',
    id: 'sp_KXBQJView_id',
    requires: [
        'Ext.Toolbar',
