...
/* JavaScript content from app/view/MyProcess/ShangHai/SHtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.MyProcess.ShangHai.SHtravelRequest', {
    extend: 'Ext.Panel',
    id: 'wdlc_SHtravelRequest_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
