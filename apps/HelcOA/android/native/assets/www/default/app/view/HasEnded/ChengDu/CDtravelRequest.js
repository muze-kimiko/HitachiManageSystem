...
/* JavaScript content from app/view/HasEnded/ChengDu/CDtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.HasEnded.ChengDu.CDtravelRequest', {
    extend: 'Ext.Panel',
    id: 'yjs_CDtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
