...
/* JavaScript content from app/view/ForApprovalProcess/HB/HB_A18.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.HB.HB_A18', {
	extend:'Ext.Panel',
	id:'sp_HB_A18_id',	//文件ID，格式:功能前缀+文件名+id，前缀：待审批(sp),已审批(ysp),已结束(yjs),我的流程(wdlc)
		...
		},
		{
			...
			},
			{
				...
				items:[ 
					...
					//日滨类流程一些必需字段，同样在非隐藏面板有的字段，这里必须去掉
