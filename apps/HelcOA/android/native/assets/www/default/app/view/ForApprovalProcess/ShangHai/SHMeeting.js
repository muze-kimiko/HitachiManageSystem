...
/* JavaScript content from app/view/ForApprovalProcess/ShangHai/SHMeeting.js in folder common */
﻿Ext.define('HelcOA.view.ForApprovalProcess.ShangHai.SHMeeting', {
    extend: 'Ext.Panel',
    id:'sp_SHMeeting_id',
    requires: [
        'Ext.Toolbar',
