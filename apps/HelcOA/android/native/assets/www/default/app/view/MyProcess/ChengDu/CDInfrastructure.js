...
/* JavaScript content from app/view/MyProcess/ChengDu/CDInfrastructure.js in folder common */
Ext
		.define(
				'HelcOA.view.MyProcess.ChengDu.CDInfrastructure',
				{
					extend : 'Ext.Panel',
					id : 'wdlc_CDInfrastructure_id',
