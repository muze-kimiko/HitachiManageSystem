...
/* JavaScript content from app/view/ForApprovalProcess/ChengDu/CDtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.ForApprovalProcess.ChengDu.CDtravelRequest', {
    extend: 'Ext.Panel',
    id: 'sp_CDtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
