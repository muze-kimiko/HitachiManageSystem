...
/* JavaScript content from app/view/Approved/TianJin/TJtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.Approved.TianJin.TJtravelRequest', {
    extend: 'Ext.Panel',
    id: 'ysp_TJtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
