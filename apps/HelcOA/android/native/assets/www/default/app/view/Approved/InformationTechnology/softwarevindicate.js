...
/* JavaScript content from app/view/Approved/InformationTechnology/softwarevindicate.js in folder common */
Ext.define('HelcOA.view.Approved.InformationTechnology.softwarevindicate', {
    extend: 'Ext.Panel',
    id: 'ysp_softwarevindicate_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
