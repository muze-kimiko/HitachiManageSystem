...
/* JavaScript content from app/view/ForApprovalProcess/ChengDu/CDInfrastructure.js in folder common */
Ext
		.define(
				'HelcOA.view.ForApprovalProcess.ChengDu.CDInfrastructure',
				{
					extend : 'Ext.Panel',
					id : 'sp_CDInfrastructure_id',
