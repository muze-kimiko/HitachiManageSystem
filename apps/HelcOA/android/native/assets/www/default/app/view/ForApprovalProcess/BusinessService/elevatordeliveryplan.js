...
/* JavaScript content from app/view/ForApprovalProcess/BusinessService/elevatordeliveryplan.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.BusinessService.elevatordeliveryplan', {
    extend: 'Ext.Panel',
    id: 'sp_elevatordeliveryplan_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
