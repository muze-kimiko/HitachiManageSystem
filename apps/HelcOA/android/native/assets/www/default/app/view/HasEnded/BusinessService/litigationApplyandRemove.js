...
/* JavaScript content from app/view/HasEnded/BusinessService/litigationApplyandRemove.js in folder common */
Ext.define('HelcOA.view.HasEnded.BusinessService.litigationApplyandRemove', {
    extend: 'Ext.Panel',
    id: 'yjs_litigationApplyandRemove_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
