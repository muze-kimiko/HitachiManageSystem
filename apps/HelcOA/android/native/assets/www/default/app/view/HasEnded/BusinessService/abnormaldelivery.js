...
/* JavaScript content from app/view/HasEnded/BusinessService/abnormaldelivery.js in folder common */
Ext.define('HelcOA.view.HasEnded.BusinessService.abnormaldelivery', {
    extend: 'Ext.Panel',
    id: 'yjs_abnormaldelivery_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
