...
/* JavaScript content from app/view/MyProcess/FuTi/FTOverseasTrip.js in folder common */
Ext.define('HelcOA.view.MyProcess.FuTi.FTOverseasTrip', {
	extend : 'Ext.Panel',
	id : 'wdlc_FTOverseasTrip_ID',
	requires : [
				'Ext.Toolbar',
				'Ext.Button',
				'Ext.Spacer',
