...
/* JavaScript content from app/view/HasEnded/ChengDu/CDFileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.HasEnded.ChengDu.CDFileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'yjs_CDFileBorrowingOrCopy_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
