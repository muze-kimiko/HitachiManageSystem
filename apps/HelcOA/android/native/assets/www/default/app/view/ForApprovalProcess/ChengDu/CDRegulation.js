...
/* JavaScript content from app/view/ForApprovalProcess/ChengDu/CDRegulation.js in folder common */
Ext
		.define(
				'HelcOA.view.ForApprovalProcess.ChengDu.CDRegulation',
				{
					extend : 'Ext.Panel',
					id : 'sp_CDRegulation_id',
