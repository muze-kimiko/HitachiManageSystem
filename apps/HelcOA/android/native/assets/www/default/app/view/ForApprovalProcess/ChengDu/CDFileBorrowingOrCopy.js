...
/* JavaScript content from app/view/ForApprovalProcess/ChengDu/CDFileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.ChengDu.CDFileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'sp_CDFileBorrowingOrCopy_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
