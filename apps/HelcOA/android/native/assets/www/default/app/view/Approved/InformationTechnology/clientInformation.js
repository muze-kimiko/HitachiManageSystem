...
/* JavaScript content from app/view/Approved/InformationTechnology/clientInformation.js in folder common */
/**
 * 客户信息登记表
 */
Ext.define('HelcOA.view.HasEnded.InformationTechnology.clientInformation', {
    extend: 'Ext.Panel',
    id: 'ysp_clientInformation_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
