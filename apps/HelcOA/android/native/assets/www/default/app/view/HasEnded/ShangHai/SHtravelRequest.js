...
/* JavaScript content from app/view/HasEnded/ShangHai/SHtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.HasEnded.ShangHai.SHtravelRequest', {
    extend: 'Ext.Panel',
    id: 'yjs_SHtravelRequest_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
