...
/* JavaScript content from app/view/HasEnded/TianJin/TJtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.HasEnded.TianJin.TJtravelRequest', {
    extend: 'Ext.Panel',
    id: 'yjs_TJtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
