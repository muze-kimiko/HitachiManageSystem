...
/* JavaScript content from app/view/ForApprovalProcess/HB/HB_A16.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.HB.HB_A16', {
	extend:'Ext.Panel',
	id:'sp_HB_A16_id',	//文件ID，格式:功能前缀+文件名+id，前缀：待审批(sp),已审批(ysp),已结束(yjs),我的流程(wdlc)
