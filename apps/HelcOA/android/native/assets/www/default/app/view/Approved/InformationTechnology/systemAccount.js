...
/* JavaScript content from app/view/Approved/InformationTechnology/systemAccount.js in folder common */
/**
 * 系统网络账号权限申请流程单
 */
Ext.define('HelcOA.view.Approved.InformationTechnology.systemAccount', {
    extend: 'Ext.Panel',
    id: 'ysp_systemAccount_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
