...
/* JavaScript content from app/view/Approved/QualityControl/ComplatinSheet.js in folder common */
/**
 * 公司级投诉电子流程表
 */
Ext.define('HelcOA.view.Approved.QualityControl.ComplatinSheet', {
    extend: 'Ext.Panel',
    id: 'ysp_ComplatinSheet_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
