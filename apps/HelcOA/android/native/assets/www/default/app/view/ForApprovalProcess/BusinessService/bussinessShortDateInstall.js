...
/* JavaScript content from app/view/ForApprovalProcess/BusinessService/bussinessShortDateInstall.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.BusinessService.bussinessShortDateInstall', {
    extend: 'Ext.Panel',
    id: 'sp_bussinessShortDateInstall_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
