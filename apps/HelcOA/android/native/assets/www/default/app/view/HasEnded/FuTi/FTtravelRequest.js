...
/* JavaScript content from app/view/HasEnded/FuTi/FTtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.HasEnded.FuTi.FTtravelRequest', {
    extend: 'Ext.Panel',
    id: 'yjs_FTtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
