...
/* JavaScript content from app/view/ForApprovalProcess/BusinessService/Legistimate.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.BusinessService.Legistimate', {
    extend: 'Ext.Panel',
    id: 'sp_Legistimate_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
