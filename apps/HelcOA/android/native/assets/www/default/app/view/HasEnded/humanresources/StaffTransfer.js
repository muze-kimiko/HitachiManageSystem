...
/* JavaScript content from app/view/HasEnded/humanresources/StaffTransfer.js in folder common */
Ext.define('HelcOA.view.HasEnded.humanresources.StaffTransfer', {
    extend: 'Ext.Panel',
		id : 'yjs_StaffTransfer_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
