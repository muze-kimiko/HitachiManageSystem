...
/* JavaScript content from app/view/HasEnded/BusinessService/elevatordeliveryplan.js in folder common */
Ext.define('HelcOA.view.HasEnded.BusinessService.elevatordeliveryplan', {
    extend: 'Ext.Panel',
    id: 'yjs_elevatordeliveryplan_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
