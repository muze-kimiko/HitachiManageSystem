...
/* JavaScript content from app/view/HasEnded/Technology/FileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.HasEnded.Technology.FileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'yjs_FileBorrowingOrCopy_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
