...
/* JavaScript content from app/view/MyProcess/InformationTechnology/softwarevindicate.js in folder common */
Ext.define('HelcOA.view.MyProcess.InformationTechnology.softwarevindicate', {
    extend: 'Ext.Panel',
    id: 'wdlc_softwarevindicate_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
