...
/* JavaScript content from app/view/MyProcess/ChengDu/CDMeeting.js in folder common */
Ext.define('HelcOA.view.MyProcess.ChengDu.CDMeeting', {
    extend: 'Ext.Panel',
    id:'wdlc_CDMeeting_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
