...
/* JavaScript content from app/view/MyProcess/ChengDu/CDtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.MyProcess.ChengDu.CDtravelRequest', {
    extend: 'Ext.Panel',
    id: 'wdlc_CDtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
