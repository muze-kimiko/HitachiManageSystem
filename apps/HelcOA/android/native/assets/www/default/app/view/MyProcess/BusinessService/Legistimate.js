...
/* JavaScript content from app/view/MyProcess/BusinessService/Legistimate.js in folder common */
Ext.define('HelcOA.view.MyProcess.BusinessService.Legistimate', {
    extend: 'Ext.Panel',
    id: 'wdlc_Legistimate_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
