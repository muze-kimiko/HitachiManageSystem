...
/* JavaScript content from app/view/MyProcess/TianJin/TJtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.MyProcess.TianJin.TJtravelRequest', {
    extend: 'Ext.Panel',
    id: 'wdlc_TJtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
