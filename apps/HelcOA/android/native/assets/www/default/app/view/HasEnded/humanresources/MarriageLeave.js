...
/* JavaScript content from app/view/HasEnded/humanresources/MarriageLeave.js in folder common */
Ext
		.define(
				'HelcOA.view.HasEnded.humanresources.MarriageLeave',
				{
					extend : 'Ext.Panel',
					id : 'yjs_MarriageLeave_id',
