...
/* JavaScript content from app/view/MyProcess/DailyOffice/CustomerReception.js in folder common */
Ext.define('HelcOA.view.MyProcess.DailyOffice.CustomerReception', {
    extend: 'Ext.Panel',
    id: 'wdlc_CustomerReception_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
