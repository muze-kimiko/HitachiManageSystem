...
/* JavaScript content from app/view/ForApprovalProcess/DailyOffice/CustomerReception.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.DailyOffice.CustomerReception', {
    extend: 'Ext.Panel',
    id: 'sp_CustomerReception_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
