...
/* JavaScript content from app/view/MyProcess/FuTi/FTtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.MyProcess.FuTi.FTtravelRequest', {
    extend: 'Ext.Panel',
    id: 'wdlc_FTtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
