...
/* JavaScript content from app/view/ForApprovalProcess/Technology/FileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.Technology.FileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'sp_FileBorrowingOrCopy_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
