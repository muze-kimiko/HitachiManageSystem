...
/* JavaScript content from app/view/MyProcess/QualityControl/ComplatinSheet.js in folder common */
/**
 * 公司级投诉电子流程表
 */
Ext.define('HelcOA.view.MyProcess.QualityControl.ComplatinSheet', {
    extend: 'Ext.Panel',
    id: 'wdlc_ComplatinSheet_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
