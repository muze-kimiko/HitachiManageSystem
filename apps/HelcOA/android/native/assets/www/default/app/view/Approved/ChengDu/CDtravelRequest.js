...
/* JavaScript content from app/view/Approved/ChengDu/CDtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.Approved.ChengDu.CDtravelRequest', {
    extend: 'Ext.Panel',
    id: 'ysp_CDtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
