...
/* JavaScript content from app/view/Approved/BusinessService/Legistimate.js in folder common */
Ext.define('HelcOA.view.Approved.BusinessService.Legistimate', {
    extend: 'Ext.Panel',
    id: 'ysp_Legistimate_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
