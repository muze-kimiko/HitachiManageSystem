...
/* JavaScript content from app/view/HasEnded/DailyOffice/CustomerReception.js in folder common */
Ext.define('HelcOA.view.HasEnded.DailyOffice.CustomerReception', {
    extend: 'Ext.Panel',
    id: 'yjs_CustomerReception_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
