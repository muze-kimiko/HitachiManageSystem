...
/* JavaScript content from app/view/ForApprovalProcess/QualityControl/StockoutsDelivery.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.QualityControl.StockoutsDelivery', {
    extend: 'Ext.Panel',
    id: 'sp_StockoutsDelivery_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
