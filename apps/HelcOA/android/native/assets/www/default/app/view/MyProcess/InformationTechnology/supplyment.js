...
/* JavaScript content from app/view/MyProcess/InformationTechnology/supplyment.js in folder common */
/**
 * 供应商信息登记表
 */
Ext.define('HelcOA.view.MyProcess.InformationTechnology.supplyment', {
    extend: 'Ext.Panel',
    id: 'wdlc_supplyment_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
