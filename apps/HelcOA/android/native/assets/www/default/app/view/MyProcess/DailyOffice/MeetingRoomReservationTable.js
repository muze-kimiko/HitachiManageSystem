...
/* JavaScript content from app/view/MyProcess/DailyOffice/MeetingRoomReservationTable.js in folder common */
Ext.define('HelcOA.view.MyProcess.DailyOffice.MeetingRoomReservationTable', {
    extend: 'Ext.Panel',
    id:'wdlc_MeetingRoomReservationTable_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
