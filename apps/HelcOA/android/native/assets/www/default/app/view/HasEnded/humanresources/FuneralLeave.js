...
/* JavaScript content from app/view/HasEnded/humanresources/FuneralLeave.js in folder common */
Ext
		.define(
				'HelcOA.view.HasEnded.humanresources.FuneralLeave',
				{
					extend : 'Ext.Panel',
					id : 'yjs_FuneralLeave_id',
