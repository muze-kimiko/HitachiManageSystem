...
/* JavaScript content from app/view/MyProcess/ChengDu/CDFileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.MyProcess.ChengDu.CDFileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'wdlc_CDFileBorrowingOrCopy_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
