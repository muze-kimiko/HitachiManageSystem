...
/* JavaScript content from app/view/Approved/BusinessService/bussinessShortDateInstall.js in folder common */
Ext.define('HelcOA.view.Approved.BusinessService.bussinessShortDateInstall', {
    extend: 'Ext.Panel',
    id: 'ysp_bussinessShortDateInstall_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
