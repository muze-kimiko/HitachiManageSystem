...
/* JavaScript content from app/view/ForApprovalProcess/FuTi/FTtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.ForApprovalProcess.FuTi.FTtravelRequest', {
    extend: 'Ext.Panel',
    id: 'sp_FTtravelRequest_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
