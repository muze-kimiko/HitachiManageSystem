...
/* JavaScript content from app/view/HasEnded/InformationTechnology/supplyment.js in folder common */
/**
 * 供应商信息登记表
 */
Ext.define('HelcOA.view.HasEnded.InformationTechnology.supplyment', {
    extend: 'Ext.Panel',
    id: 'yjs_supplyment_ID',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
