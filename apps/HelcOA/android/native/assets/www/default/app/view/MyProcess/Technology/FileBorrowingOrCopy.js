...
/* JavaScript content from app/view/MyProcess/Technology/FileBorrowingOrCopy.js in folder common */
Ext.define('HelcOA.view.MyProcess.Technology.FileBorrowingOrCopy', {
    extend: 'Ext.Panel',
    id: 'wdlc_FileBorrowingOrCopy_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
