...
/* JavaScript content from app/view/ForApprovalProcess/HB/HB_H15.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.HB.HB_H15', {
	extend:'Ext.Panel',
	id:'sp_HB_H15_id',	//文件ID，格式:功能前缀+文件名+id，前缀：待审批(sp),已审批(ysp),已结束(yjs),我的流程(wdlc)
