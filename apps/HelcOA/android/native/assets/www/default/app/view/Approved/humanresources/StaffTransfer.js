...
/* JavaScript content from app/view/Approved/humanresources/StaffTransfer.js in folder common */
Ext.define('HelcOA.view.Approved.humanresources.StaffTransfer', {
    extend: 'Ext.Panel',
		id : 'ysp_StaffTransfer_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
