...
/* JavaScript content from app/view/HasEnded/QualityControl/StockoutsDelivery.js in folder common */
Ext.define('HelcOA.view.HasEnded.QualityControl.StockoutsDelivery', {
    extend: 'Ext.Panel',
    id: 'yjs_StockoutsDelivery_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
