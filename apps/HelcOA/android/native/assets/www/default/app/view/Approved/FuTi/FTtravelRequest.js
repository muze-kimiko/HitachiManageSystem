...
/* JavaScript content from app/view/Approved/FuTi/FTtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.Approved.FuTi.FTtravelRequest', {
    extend: 'Ext.Panel',
    id: 'ysp_FTtravelRequest_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
