...
/* JavaScript content from app/view/Approved/InformationTechnology/DataMaintenance.js in folder common */
/*
...
Ext.define('HelcOA.view.Approved.InformationTechnology.DataMaintenance', {
    extend: 'Ext.Panel',
    id: 'ysp_DataMaintenance_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
