...
/* JavaScript content from app/view/MyProcess/BusinessService/abnormaldelivery.js in folder common */
Ext.define('HelcOA.view.MyProcess.BusinessService.abnormaldelivery', {
    extend: 'Ext.Panel',
    id: 'wdlc_abnormaldelivery_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
