...
/* JavaScript content from app/view/HasEnded/DailyOffice/contractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.HasEnded.DailyOffice.contractExamine', {
    extend: 'Ext.Panel',
    id:'yjs_contractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
