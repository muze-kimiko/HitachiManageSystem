...
/* JavaScript content from app/view/Approved/ShangHai/SHtravelRequest.js in folder common */
/**
 * 出差申请表
 */
Ext.define('HelcOA.view.Approved.ShangHai.SHtravelRequest', {
    extend: 'Ext.Panel',
    id: 'ysp_SHtravelRequest_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
