...
/* JavaScript content from app/view/ForApprovalProcess/FuTi/FTOverseasTrip.js in folder common */
Ext.define('HelcOA.view.ForApprovalProcess.FuTi.FTOverseasTrip', {
	extend : 'Ext.Panel',
	id : 'sp_FTOverseasTrip_ID',
	requires : [
				'Ext.Toolbar',
				'Ext.Button',
				'Ext.Spacer',
