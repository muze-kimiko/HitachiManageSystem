...
/* JavaScript content from app/view/HasEnded/InformationTechnology/DataMaintenance.js in folder common */
/*
...
Ext.define('HelcOA.view.HasEnded.InformationTechnology.DataMaintenance', {
    extend: 'Ext.Panel',
    id: 'yjs_DataMaintenance_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
