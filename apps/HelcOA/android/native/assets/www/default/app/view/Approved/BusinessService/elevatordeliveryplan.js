...
/* JavaScript content from app/view/Approved/BusinessService/elevatordeliveryplan.js in folder common */
Ext.define('HelcOA.view.Approved.BusinessService.elevatordeliveryplan', {
    extend: 'Ext.Panel',
    id: 'ysp_elevatordeliveryplan_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
