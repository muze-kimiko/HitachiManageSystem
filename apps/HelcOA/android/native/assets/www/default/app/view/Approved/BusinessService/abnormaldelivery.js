...
/* JavaScript content from app/view/Approved/BusinessService/abnormaldelivery.js in folder common */
Ext.define('HelcOA.view.Approved.BusinessService.abnormaldelivery', {
    extend: 'Ext.Panel',
    id: 'ysp_abnormaldelivery_id',
    requires: [
               'Ext.Toolbar',
               'Ext.Button',
               'Ext.Spacer',
