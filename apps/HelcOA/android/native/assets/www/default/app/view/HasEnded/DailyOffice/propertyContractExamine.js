...
/* JavaScript content from app/view/HasEnded/DailyOffice/propertyContractExamine.js in folder common */
/*
...
Ext.define('HelcOA.view.HasEnded.DailyOffice.propertyContractExamine', {
    extend: 'Ext.Panel',
    id:'yjs_propertyContractExamine_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
