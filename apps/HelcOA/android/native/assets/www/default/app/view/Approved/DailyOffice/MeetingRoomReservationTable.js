...
/* JavaScript content from app/view/Approved/DailyOffice/MeetingRoomReservationTable.js in folder common */
Ext.define('HelcOA.view.Approved.DailyOffice.MeetingRoomReservationTable', {
    extend: 'Ext.Panel',
    id:'ysp_MeetingRoomReservationTable_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
