...
/* JavaScript content from app/view/HasEnded/ShangHai/SHAbnormalQuality.js in folder common */
Ext
		.define(
				'HelcOA.view.HasEnded.ShangHai.SHAbnormalQuality',
				{
					extend : 'Ext.Panel',
					id : 'yjs_SHAbnormalQuality_id',
