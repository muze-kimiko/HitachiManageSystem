...
/* JavaScript content from app/view/Approved/InformationTechnology/Permissions.js in folder common */
/*
...
Ext.define('HelcOA.view.Approved.InformationTechnology.Permissions', {
    extend: 'Ext.Panel',
    id: 'ysp_Permissions_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
