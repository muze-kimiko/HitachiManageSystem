...
/* JavaScript content from app/view/Approved/FuTi/FTOverseasTrip.js in folder common */
Ext.define('HelcOA.view.Approved.FuTi.FTOverseasTrip', {
	extend : 'Ext.Panel',
	id : 'ysp_FTOverseasTrip_ID',
	requires : [
				'Ext.Toolbar',
				'Ext.Button',
				'Ext.Spacer',
