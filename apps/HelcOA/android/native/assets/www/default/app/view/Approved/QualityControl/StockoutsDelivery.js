...
/* JavaScript content from app/view/Approved/QualityControl/StockoutsDelivery.js in folder common */
Ext.define('HelcOA.view.Approved.QualityControl.StockoutsDelivery', {
    extend: 'Ext.Panel',
    id: 'ysp_StockoutsDelivery_id',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
