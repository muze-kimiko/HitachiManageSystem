...
/* JavaScript content from app/view/Approved/BusinessService/MaintainTransformView.js in folder common */
Ext.define('HelcOA.view.Approved.BusinessService.MaintainTransformView', {
    extend: 'Ext.Panel',
    id: 'ysp_MaintainTransformView_ID',
    requires: [
        'Ext.Toolbar',
        'Ext.Button',
        'Ext.Spacer',
