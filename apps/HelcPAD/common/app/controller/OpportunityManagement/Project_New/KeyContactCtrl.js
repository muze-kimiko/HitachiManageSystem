Ext.define('HelcPAD.controller.OpportunityManagement.Project_New.KeyContactCtrl',{
	...
	toKeyContactAccount:function(){
		...
		Ext.getCmp('comeSource').setValue('HelcPAD.controller.OpportunityManagement.Project_New.KeyContactCtrl');
	},
	//联系人列表单击
	...
	buildContact:function(){
		this.NextView('keyContactConstructPanel','HelcPAD.view.OpportunityManagement.Project_New.KeyContactConstructView');
