Ext.define('HelcPAD.controller.Remind.RemindListCtrl', {
	...
	//获取推送商机的详细信息
	getMqttBusiness:function(RowID){
		object.getApplication().getController('HelcPAD.controller.Remind.RemindListCtrl').LY='提醒';
		object.getApplication().getController('HelcPAD.controller.OpportunityManagement.Project_New.ProjectListCtrl').projectListTwo(RowID);
	},
