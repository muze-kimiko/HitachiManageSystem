...
Ext.define('HelcPAD.controller.OpportunityManagement.Project_New.InstallSiteCtrl',{
	...
	//确认选择安装地点
	confirmInstallSite:function(){
		var items = Ext.getCmp('installSiteList').getSelection();
		if(!items.length){
			Ext.Msg.alert('提示','请选择确认一项！');
			return ;
		}
		var record = items[0];
		...
		if(installSiteComeSource=='HelcPAD.controller.OpportunityManagement.Project_New.ProjectInfoCtrl'){
		...
		}else if(installSiteComeSource=='HelcPAD.controller.OpportunityManagement.Project_New.ProjectSearchPrepareCtrl'){
			Ext.getCmp('setPlace').setValue(installSite.HELAddress);
		}else if(installSiteComeSource=='HelcPAD.controller.OpportunityManagement.Agents.ClueCreateAgentCtrl'){
		...
		}else if(installSiteComeSource=='HelcPAD.controller.OpportunityManagement.Director.ClueHandleDirectorCtrl'){
			...
			if(LeadSource=='经销商'){
				cc.log('进入线索专用');
				Ext.getCmp('Clue_ProjectArea').setValue(installSite.HELProject_Area);
				Ext.getCmp('Clue_Province').setValue(installSite.HELProvince);
				Ext.getCmp('Clue_City').setValue(installSite.HELCity);
				Ext.getCmp('Clue_County').setValue(installSite.HELCounty);
				Ext.getCmp('Clue_StreetAddress').setValue(installSite.HELAddress);
			}else if(LeadSource=='外部线索'){
				cc.log('进入线索专用');
				Ext.getCmp('BCI_ProjectArea').setValue(installSite.HELProject_Area);
				Ext.getCmp('BCI_Province').setValue(installSite.HELProvince);
				Ext.getCmp('BCI_City').setValue(installSite.HELCity);
				Ext.getCmp('BCI_County').setValue(installSite.HELCounty);
				Ext.getCmp('BCI_StreetAddress').setValue(installSite.HELAddress);
			};
			this.getApplication().getController('OpportunityManagement.Director.ClueNewCtrl').StreetAddress=installSite.HELAddress;
		};
		//清空数据
	...
	toInstallSiteBuild:function(){
		this.NextView('installSiteBuildPanel','HelcPAD.view.OpportunityManagement.Project_New.InstallSiteBuildView');
