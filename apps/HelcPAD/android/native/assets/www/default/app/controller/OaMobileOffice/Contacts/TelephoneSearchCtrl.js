...
/* JavaScript content from app/controller/OaMobileOffice/Contacts/TelephoneSearchCtrl.js in folder common */
Ext.define('HelcPAD.controller.OaMobileOffice.Contacts.TelephoneSearchCtrl',{
	...
	telephonesearch_id_seach : function(){
       ...
       if(tempValue[1]!=''){
		...
		function fn(result) {
			...
			this_obj.NextView('telephonelist_id','HelcPAD.view.OaMobileOffice.Contacts.TelephoneList');
			...
			if (Ext.os.is.Android) {
				html='<table border=0 width=100% style="color:#666" class="textf">'+
				'  <tr>'+
			...
			Ext.getCmp('telephonelist_id_list').setItemTpl(html);
	...
	telephonesearch_id_FH:function(){
		this.showBackView('installProject_oa_id','HelcPAD.view.OaMobileOffice.installProject');
	},*/
