...
/* JavaScript content from app/controller/OaMobileOffice/ElectronicProcess/OverseasTripCtrl/qyeryListCtrl.js in folder common */
/**
 * 起草流程-人员查询列表
 */
Ext.define('HelcPAD.controller.OaMobileOffice.ElectronicProcess.OverseasTripCtrl.qyeryListCtrl',{
	extend:'HelcPAD.controller.ApplicationController',
	id:'qc_qyeryListCtrl_ID',
	config:{
		control:{
	...
	qc_returnPersonnelSelection : function(obj, e, eOpts){
		this.showBackView('qc_personnelSelection_id','HelcPAD.view.OaMobileOffice.ElectronicProcess.OverseasTrip.personnelSelection');
	},	
	//选择人员
