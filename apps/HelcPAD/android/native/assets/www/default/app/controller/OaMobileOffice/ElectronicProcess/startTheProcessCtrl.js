...
/* JavaScript content from app/controller/OaMobileOffice/ElectronicProcess/startTheProcessCtrl.js in folder common */
		...
		var getResult=function(res){
			...
			for(var j=0;j<userSolist.length;j++){
				...
				if(record.data.title=="人力资源"){
					...
					if(userSolist[j].bpdname=="人员转_调岗申请"){
						listdata[cs]=userSolist[j];
						cs++;
					}
					if(userSolist[j].bpdname=="公积金申请"){
						listdata[cs]=userSolist[j];
						cs++;
					}
				}
