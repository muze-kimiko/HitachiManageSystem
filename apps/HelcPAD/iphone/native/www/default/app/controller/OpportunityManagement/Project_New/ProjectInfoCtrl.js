...
/* JavaScript content from app/controller/OpportunityManagement/Project_New/ProjectInfoCtrl.js in folder common */
	...
	projectinfo_new_id_QTXX_SJLSYYFX:function(){
		...
		if(opportunity.OpptyStatus){
			...
			getResult = function(result){
				...
				'        <div name="groupkung_opportunityoutflowreasonanalysislist" style="{OpptyType}" class="p_judge_box2" id="conkung_opportunityoutflowreasonanalysislist">3</div>'+
				'     </td>'+
				...
				if(power=='Manager'){
					...
					if(opportunity.OpptyStatus!='流失'&&opportunity.OpptyStatus!='完成'&&opportunity.OpptyStatus!='申请流失')
