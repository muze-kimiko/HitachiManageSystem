...
Ext.define('HelcPAD.controller.OpportunityManagement.Project_New.ProjectCtrl',{
	...
	projectlist_new_id_XZ:function(){
		this.NextView('projectinfo_new_id','HelcPAD.view.OpportunityManagement.Project_New.ProjectSearchPrepare');
		Ext.getCmp('projectsearchprepare_new_id_XZ').setValue('A线');
	},
	//商机资料  返回
	projectlist_new_id_FH:function(){
		this.showBackView('projectsearch_new_id','HelcPAD.view.OpportunityManagement.Project_New.ProjectSearch');
	},
