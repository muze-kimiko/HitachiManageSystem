...
Ext.define('HelcPAD.controller.OpportunityManagement.Project_New.ProjectListCtrl',{
	...
	projectList:function( theList, index, target, record, e, eOpts ){
		...
		object.getApplication().getController('HelcPAD.controller.OpportunityManagement.Project_New.ProjectListCtrl').ListZT=data.OpptyStatus;//(Ctrl:ProjectInfoCtrl,方法:getSMandZGYJ)
		//用户查询商机的关注人
		object.getApplication().getController('HelcPAD.controller.OpportunityManagement.Project_New.ProjectListCtrl').BusinessID=data.RowId;//(Ctrl:ProjectInfoCtrl,方法:projectinfo_new_id_GZR)和(ConcernedAboutPeopleCtrl,方法:ConcernedAboutPeople_id_TJ)
		var obj = this;
		obj.status = 'detail';
		var param = {
				id:data.RowId,
