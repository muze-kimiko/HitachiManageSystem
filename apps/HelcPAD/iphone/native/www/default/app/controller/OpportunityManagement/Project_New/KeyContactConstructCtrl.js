...
/* JavaScript content from app/controller/OpportunityManagement/Project_New/KeyContactConstructCtrl.js in folder common */
Ext.define('HelcPAD.controller.OpportunityManagement.Project_New.KeyContactConstructCtrl',{
			   ...
			   fn: function(buttonId) {
		 		...
		 		var getResult = function(result){
		 			...
		 			if(!result.OpptyContactSynchronize_Output){
		 				...
		 				Ext.Msg.alert('提示','新建联系人成功，您可选择该联系人或重新查找！');
	...
	toKeyContactConstructAccount:function(){
		...
		Ext.getCmp('comeSource').setValue('HelcPAD.controller.OpportunityManagement.Project_New.KeyContactConstructCtrl');
